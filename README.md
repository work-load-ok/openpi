...
```bash
git clone --recurse-submodules git@github.com:work-load-ok/openpi.git
...
```bash
XLA_PYTHON_CLIENT_MEM_FRACTION=0.9 uv run scripts/train_pytorch.py pi05_libero --exp-name=my_experiment --overwrite
```
